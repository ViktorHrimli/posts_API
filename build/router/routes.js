...
router.post("/sendMail", storage_1.upload.single("photo"), function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, name, surname, email, phone;
    return __generator(this, function (_b) {
        ...
        {
            // await sendEmail(name, surname, email, phone, req.file);
        }
        return [2 /*return*/];
    });
}); });
